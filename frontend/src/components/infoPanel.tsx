                    ...
                    <div id="info-content" className="mt-4 grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="rounded-xl border bg-white p-4">
                            ...
                            <ul className="mt-2 space-y-2 text-sm text-neutral-700 list-disc list-inside">
                                <li>&ldquo;Summarize Adharsh&rsquo;s <span className="font-medium">work experience</span>.&rdquo;</li>
                                <li>&ldquo;What <span className="font-medium">projects</span> has Adharsh built in AI and backend systems?&rdquo;</li>
                                <li>&ldquo;Explain his role at <span className="font-medium">IBM</span> and what he accomplished there.&rdquo;</li>
                                <li>&ldquo;What are some examples of <span className="font-medium">system design</span> problems he has solved?&rdquo;</li>
                                <li>&ldquo;What <span className="font-medium">skills and tools</span> does he use most often?&rdquo;</li>
                            </ul>
                        </div>
